...
explore: vw_medical {
  ...
  sql_always_where: ${Paid_year} IN ('2018', '2019', '2020', '2021') ;;
}
...
explore: ad_hoc_query_tool_medical {
  ...
  sql_always_where: ${PAID_DATE_year} IN ('2018', '2019', '2020', '2021') ;;
}
...
explore: vw_risk_group_migration {
  ...
  sql_always_where: ${File_year} IN ('2018', '2019', '2020', '2021') ;;
}
