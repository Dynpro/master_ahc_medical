...
explore: vw_medical {
  ...
  sql_always_where: ${Paid_year} IN ('2019', '2020', '2021') ;;
}

explore: vw_pharmacy {
  label: "Pharmacy records"
  sql_always_where: ${date_filled_year} IN ('2019', '2020', '2021') ;;
}

explore: vw_med_and_pharma_summary_1 {
  label: "Ad Hoc Query Tool"
  sql_always_where: ${PAID_DATE_year} IN ('2019', '2020', '2021') ;;
}
...
explore: ad_hoc_query_tool_pharmacy {
  ...
  sql_always_where: ${SERVICE_DATE_year} IN ('2019', '2020', '2021') ;;
}
...
explore: vw_risk_group_migration {
  ...
  sql_always_where: ${File_year} IN ('2019', '2020', '2021') ;;
}
...
explore: vw_medication_possession_ratio {
  ...
  sql_always_where: ${year} IN ('2019', '2020', '2021') ;;
}

explore: vw_preventive_screening {
  label: "Preventive Screening"
  sql_always_having: ${year} IN ('2019', '2020', '2021') ;;
}
